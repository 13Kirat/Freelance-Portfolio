...
const ManageTips = () => {
  ...
  const { tips, loading, error, message } = useSelector(
    (state) => state.tip
  );
  ...
  return (
    <>
      <div className="flex min-h-screen w-full flex-col bg-muted/40 sm:pl-20">
        <Tabs defaultValue="week">
          <TabsContent value="week">
            <Card>
              <CardHeader className="flex gap-4 sm:justify-between sm:flex-row sm:items-center">
                <CardTitle>Manage Your Tips</CardTitle>
                          ...
                          <TableRow className="bg-accent" key={element._id}>
                            ...
                            <TableCell className="flex flex-row items-center gap-3 h-24">
                              ...
                              <TooltipProvider>
                                <Tooltip>
                                  <TooltipTrigger asChild>
                                    <Link to={`/update/tip/${element._id}`}>
