...
export const getAllTips = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      "https://freelance-portfolio-production-6486.up.railway.app/api/v1/tip/getall",
...
export const addNewTip = (data) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(
      "https://freelance-portfolio-production-6486.up.railway.app/api/v1/tip/add",
      data,
      {
        withCredentials: true,
...
export const deleteTip = (id) => async (dispatch) => {
  ...
  try {
    const response = await axios.delete(
      `https://freelance-portfolio-production-6486.up.railway.app/api/v1/tip/delete/${id}`,
      {
        withCredentials: true,
      }
    );
...
export const updateTip = (id, newData) => async (dispatch) => {
  ...
  try {
    const response = await axios.put(
      `https://freelance-portfolio-production-6486.up.railway.app/api/v1/tip/update/${id}`,
      newData,
      {
        withCredentials: true,
        headers: { "Content-Type": "multipart/form-data" },
